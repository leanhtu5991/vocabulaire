...
INSERT INTO vocabulary.box (id,`time`,description,name)
VALUES (2,'Level 2: Word appears after 2 days','BOX 2');
INSERT INTO vocabulary.box (id,`time`,description,name)
VALUES (3,'Level 3: Word appears after 3 days','BOX 3');
...
VALUES(1, 'adm@admin.com', 'Admin', '123456', NULL, 1, '0155224488', NULL, 1);
